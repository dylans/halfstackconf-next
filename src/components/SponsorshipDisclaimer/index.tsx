...
const paragraphs = [
  "Sponsorship does not include things that do not improve the attendee experience, including email lists of attendees, speaking slots, booths/stands without a benefit for attendees, etc.",
